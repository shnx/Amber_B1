        ...
        while not rospy.is_shutdown():
            try:
                ...
                if (len(Joints_state.position) > 0):
                    ...
                    #print("#############################################")
                    print("Joint position 0", Joints_state.position[0])
                    print("Joint position 1", Joints_state.position[1])
                    print("Joint position 2", Joints_state.position[2])
                    print("Joint position 3", Joints_state.position[3])
                    print("Joint position 4", Joints_state.position[4])
                    print("Joint position 5", Joints_state.position[5])
                    print("Joint position 6", Joints_state.position[6])
                    ...
                    self.points.time_from_start=rospy.Time.now()
